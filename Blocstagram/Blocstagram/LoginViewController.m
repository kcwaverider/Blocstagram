...
- (void)viewDidLoad {
    ...
    NSString *urlString = [NSString stringWithFormat:@"https://instagram.com/oauth/authorize/?client_id=%@&redirect_uri=%@&scope=likes+comments+relationships&response_type=token", [DataSource instagramClientID], [self redirectURI]];
